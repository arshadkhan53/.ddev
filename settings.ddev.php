...
$expo = explode('.', $_SERVER['HTTP_HOST']);
$active_db = $expo[0];
...
$settings['hash_salt'] = 'WoGRBpFCMHhANIBTTxTyRHawIEddcRkfnZspEIhxZkcTpTBaGIuEsQoSwLTjtROY';
...
$config['config_split.config_split.' . $active_db]['status'] = TRUE;
...
if (version_compare(DRUPAL::VERSION, "8.8.0", '>=') &&
  ...
  //$settings['config_sync_directory'] = '../../../config/sites/'. $active_db;
}
